...
class PSAgent(Agent):
    ...
    def __init__(self, problem: 'HPProblem', id: str, team: str, k: int = None, l: int = None, heuristic: list = None):
    ...
    def draw_heuristic(self, problem: 'HPProblem', k: int, l: int):
...
class HPProblem(Model):
    ...
    def __init__(self, n: int, k: int, l: int, N_agents: int, seed: int = None, agent_class: Agent = PSAgent): 
    ...
    def max_search(self, agent: Agent = None, heuristic: list = None, update: bool = True) -> tuple:
    ...
    def __sample_from_dict(self, d: dict, n: int): #From https://stackoverflow.com/a/66018057/10581449
    ...
    def dict_mean(self, dict_list: list) -> dict:
